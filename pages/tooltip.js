...
const TooltipPageComponent = ({ className }) => (
  <ThemeProvider>
    <div className={className}>
      ...
      <p>{"Pass in whatever content you would like as a child of the tooltip component. *Teeechnically* material design wants you to only pass in a string, but you can pass in a react component as well. Images are not supported yet because on initial render they aren't calculated into the portal height."}</p>
      ...
      <ul>
        ...
        <li>{"width?: number. Optional but recommended. If you do not pass this in and you pass in a string as the tooltip content, it will try to guess the width, but it's not very good at it. If you pass in a react component it will default to 30px, which is unlikley to be what you want."}
        </li>
        <li>
