...
import { type StyledMaterialComponentsThemeType } from "./types";
...
const minW = (min: number): string => `(min-width: ${min}px)`;
const maxW = (max: number): string => `(max-width: ${max}px)`;
const o = (or: OrientationType): string => `(orientation: ${or})`;
...
export const defaultTheme: StyledMaterialComponentsThemeType = {
  primary: "#3f51b5",
  accent: "#ff4081",
  white: "#ffffff",
  layout: {
