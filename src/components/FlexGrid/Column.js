 ...
 * any styled on this component by importing Column and styled()
 ...
 * styled component to be used for styled()'ing and for targeting in other
...
export const Column = enhancer(BaseColumnComponent);
